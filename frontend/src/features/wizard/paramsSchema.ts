...
const STAFF_SECTION: ParamSection = {
  ...
  fields: [
    ...
    { key: 'staff_cost_per_month', label: 'Стоимость одного сотрудника', kind: 'number', unit: '₽/мес', required: true, min: 1, typicalMax: 400_000, hint: 'с налогами и взносами', help: 'Полная стоимость для работодателя: зарплата, НДФЛ, страховые взносы. Обычно это зарплата × 1,3.' },
  ],
};
